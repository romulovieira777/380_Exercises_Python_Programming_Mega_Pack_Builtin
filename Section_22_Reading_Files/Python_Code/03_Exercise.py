...
The playway.csv contains Playway listing for March 2020. This file was loaded as follows to the content variable:
...
with open('../Files/playway.csv', 'r') as file:
    ...
    closes = [float(line.split(',')[4]) for line in content[1:]]
    result = {'Date': dates, 'Close': closes}
    print(result)
