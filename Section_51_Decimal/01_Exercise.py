...
Using the built-in decimal module, create two decimal numbers 0.1 and 0.2 and calculate their sum. Display the result to
the console. Pay attention to the number of decimal places (precision). By default, it is set to 28.
